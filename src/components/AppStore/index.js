...
class AppStore extends Component {
  ...
  getTabFilteredProjects = () => {
    ...
    const filteredProjects = appsList.filter(item =>
      item.category.toLowerCase().includes(activeTabId.toLowerCase()),
    )
  ...
  render() {
    ...
    const filteredProjects = this.getTabFilteredProjects()
    const filteredResults = filteredProjects.filter(item =>
